...
**Student ID / Enrollment:** 150096725162 
...
### Installation
```bash
git clone https://github.com/harish0stack/assignment-13-realtime-chat-application.git
cd "assignment-13-realtime-chat-application/Harish-Malviya"
npm install
```
...
2. Connect your GitHub repository: `harish0stack/assignment-13-realtime-chat-application`.
3. Configure the build parameters:
   - **Root Directory:** `Harish-Malviya`
...
## 👨‍💻 Student Information
- **Name:** Harish Malviya
- **Student ID:** 150096725162
(https://github.com/harish0stack/assignment-13-realtime-chat-application)
